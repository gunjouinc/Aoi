...
# since gyp_chromium is automatically forcing its inclusion.
{
    ...
    'variables': {
      'variables': {
        ...
        'conditions': [
          ...
          ['OS=="linux" and chromeos==0 and ((branding=="Aoi" and buildtype=="Official") or target_arch=="arm" or target_arch=="mipsel" or use_sysroot==1)', {
  ...
  'target_defaults': {
    ...
    'conditions': [
      ...
      ['fieldtrial_testing_like_official_build==0 and branding!="Aoi"', {
